...
export const projectsStyles = {
  ...
  card: "flex flex-col h-[380px]",
  clickable: "cursor-pointer",
  imageWrap: "relative w-full h-40 shrink-0",
  imageWrapLg: "relative w-full h-60 sm:h-72",
  body: "flex flex-col gap-2 flex-1",
  name: "font-medium text-lg",
  desc: "text-sm text-foreground/80 line-clamp-3",
  header: "flex items-center gap-2",
  chevron: "w-4 h-4 ml-auto transition-transform",
  chevronOpen: "rotate-90",
  details: "mt-2 space-y-2",
  tags: "mt-2 flex flex-wrap gap-1.5",
  tag: "text-xs px-2.5 py-1 rounded-full bg-foreground/8 border border-foreground/15 text-foreground/75 font-medium",
  tagMore: "text-xs px-2.5 py-1 rounded-full bg-foreground/5 border border-foreground/10 text-foreground/45 font-medium",
  links: "mt-1 flex gap-3",
